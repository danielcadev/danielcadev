...
| --- | --- | --- |
| SecureFlow | Local-first Rust platform combining deterministic scanning, human-reviewed evidence, advisory provenance, benchmark contracts, and offline Next.js/API inventory. v0.2.0 adds sealed Web scopes and synthetic API-risk corpus generation without network scanning. | [Repository](https://github.com/danielcadev/secureflow) · [v0.2.0](https://github.com/danielcadev/secureflow/releases/tag/v0.2.0) |
